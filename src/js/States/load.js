var loadState = {
    ...
    game.load.spritesheet('rocketDoor', 'assets/Map/rocketDoor.png', 160, 92);
		game.load.image('box', 'assets/Canvas/Conversationbox.png'); //La caja donde irán los diálogos del juego
    ...
    game.load.image('dropMisiles', 'assets/PlayerThings/dropMisiles.png', 20, 13);
		game.load.bitmapFont('desyrel', 'assets/carrier_command.png', 'assets/carrier_command.xml');
		game.floaterGroup = new Group(); //Grupo que contendrá a los floaters del juego

		//Diálogos
		game.load.json('firstDialog', 'assets/Canvas/Conversations/prueba.json');
